...
<input value="全选" type="button" />
<form method="post" action="batchAdd">
<?php 
if(isset($_POST['Search'])){
?>
...
?>
	<li>
		...
		<input type="hidden" name="Item[Item<?php echo $counter;?>][cid]" value="<?php echo $taobaoke_item->cid; ?>" />
		...
		<input id="_checkbox" type="checkbox" name="Item[Item<?php echo $counter;?>][check]"/>
...
<input target="_blank" type="submit" value="提交" />
</form>
